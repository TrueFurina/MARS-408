...
> 
> **注意**: 本文档描述的是 2026-07-04 时的架构快照（历史文档，软件杯阶段的技术债务分析仍具参考价值）。当前系统已演进至 11 节点 StateGraph（新增 Triage + Evidence Check + Quality Gate）、43 路由模块、1133 项测试（915 passed / 207 skipped）。架构设计原则和 ADR 决策仍然有效。
