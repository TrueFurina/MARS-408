...
.brand-badge { display: inline-block; padding: 3px 12px; border-radius: 20px; background: rgba(var(--accent-rgb),0.15); color: var(--color-accent-text); font-size: 11px; border: 1px solid rgba(var(--accent-rgb),0.2); margin-bottom: 14px; }
.brand-logo { margin-bottom: 8px; }
.logo-m { font-size: 36px; font-weight: 800; color: #fff; letter-spacing: -1px; }
.logo-a { font-size: 36px; font-weight: 800; background: linear-gradient(135deg,var(--color-accent),var(--color-accent-text)); -webkit-background-clip: text; -webkit-text-fill-color: transparent; background-clip: text; }
...
.err { padding: 10px 14px; background: rgba(var(--danger-rgb),0.1); border: 1px solid rgba(var(--danger-rgb),0.2); border-radius: 10px; color: var(--color-danger); font-size: 13px; }
.sbtn { width: 100%; padding: 13px; border: none; border-radius: 10px; background: linear-gradient(135deg,var(--color-accent),var(--color-accent-solid)); color: #fff; font-size: 16px; font-weight: 600; cursor: pointer; transition: all 0.2s; display: flex; align-items: center; justify-content: center; gap: 8px; }
...
.bot-link { background: none; border: none; color: var(--color-accent-text); font-size: 14px; cursor: pointer; margin-left: 4px; padding: 0; }
...
.demo code { padding: 1px 6px; background: rgba(var(--accent-rgb),0.1); border-radius: 4px; font-size: 12px; color: var(--color-accent-text); }
</style>