...
.page-head .sub { color: var(--text-muted); font-size: var(--text-sm); margin: 0 0 var(--space-5); }
...
.quiz-meta { display: flex; align-items: center; gap: var(--space-3); font-size: var(--text-sm); color: var(--text-muted); margin-bottom: var(--space-2); flex-wrap: wrap; }
...
.option-btn:hover { border-color: var(--accent-primary-30); }
.option-btn.selected { border-color: var(--color-accent); background: var(--accent-primary-10); }
...
.result-total .label { display: block; color: var(--text-muted); font-size: var(--text-sm); }
.result-total .value { font-size: 52px; font-weight: var(--weight-bold); }
.phase-tag { display: inline-block; margin-left: var(--space-2); background: var(--accent-primary-10); color: var(--color-accent); padding: 2px 10px; border-radius: 999px; font-size: var(--text-xs); vertical-align: super; }
...
.delta-total { font-size: var(--text-base); margin-bottom: 14px; color: var(--text-secondary); }
