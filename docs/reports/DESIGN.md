...
> **参考基准（品牌参考库校准）**：Linear 的品牌靛紫三阶 `#5e6ad2`（实底）/ `#7170ff`（强调）/ `#828fff`（悬浮）——本系统 `#6b5cdb` / `#7c6af2` / `#8b7bf5` 与其同族同档，沿用 Linear「全站唯一彩色 = 品牌靛紫，其余一律灰阶」的纪律。<!-- token-exception: 品牌参考库比对值，非本系统令牌 -->
